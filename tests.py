...
import unittest
from Sudoku import Sudoku, all_different, is_in_sq
...
class TestSudoku(unittest.TestCase):
    ...
    def test_is_valid(self):
        ...
        self.assertEqual(true_grid.valid, True)
        self.assertEqual(false_grid.valid, False)
    ...
    def test_is_feasible(self):
        ...
        self.assertEqual(true_grid.feasible, True)
        self.assertEqual(false_grid.feasible, False)
    ...
    def test_is_solved(self):
        ...
        self.assertEqual(true_grid.solved, True)
        self.assertEqual(false_grid.solved, False)
